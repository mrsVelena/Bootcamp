...
plt.plot(real_stock_price, color = 'red', label = 'Real MS Stock Price')
plt.plot(predicted_stock_price, color = 'blue', label = 'Predicted MS Stock Price')
plt.title('MS Stock Price Prediction')
plt.xlabel('Time')
